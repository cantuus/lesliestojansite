                                ...
                                <div className="couple-wrap couple-wrap-2">
                                    ...
                                    <div className="couple-text">
                                        <div className="couple-content">
                                            <h3>Ashley Leslie</h3>
                                            <p>Hi I am Ashley Leslie. I am going to introduce myself.I am a professional graphic designer professional graphic designer going to introduce myself.I am going to introduce myself.</p>
                                        </div>
                            ...
                            <div className="col-lg-5 col-md-12 col-sm-12 couple-single">
                                <div className="couple-wrap couple-wrap-3">
                                    ...
                                    <div className="couple-text">
                                        <div className="couple-content">
                                            <h3>Cory Stojan</h3>
                                            <p>Hi I am Cory Stojan. I am going to introduce myself.I am a professional graphic designer professional graphic designer going to introduce myself.I am going to introduce myself.</p>
                                        </div>
                                        <div className="social-icon">
                                            <ul className="d-flex">
                                                <li><Link to='/'><span className="fa fa-facebook"></span></Link></li>
