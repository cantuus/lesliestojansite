        ...
        <div id="event" className="service-area section-padding">
            <div className="container">
                ...
                <div className="service-area-menu">
                    <h3 className='location-reminder'>***Reminder to arrive on time (with enough time to park your vehicle) ideally before 2:50pm because the venue has a strict timetable and we will be starting the ceremony right at <b>3:00pm</b></h3>
